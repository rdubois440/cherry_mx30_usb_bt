...
On this row, if keys are unpressed, switches are open and pullup resistor internal to the arduino pull the input pins high
...
The diodes prevent the current to flow backwards through one of the switches, and the ghost key effect
...
##9- Mode Switch - USB or Bluetooth
